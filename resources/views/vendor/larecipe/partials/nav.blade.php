<div class="fixed pin-t pin-x z-40">
    ...
    <nav class="flex items-center justify-between text-black bg-navbar shadow-xs h-16">
        <div class="flex items-center flex-no-shrink">
            <a href="{{ route('dashboard') }}" class="flex items-center flex-no-shrink text-black mx-4">
            ...
            <div class="switch">
                <button @click="sidebar=!sidebar">
                    <svg class="w-6 h-6" v-show="!sidebar" fill="none" stroke-linecap="round" stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" v-cloak>
                        <path d="M4 6h16M4 12h16M4 18h16"></path>
                    </svg>
                    <svg class="w-6 h-6" v-show="sidebar" fill="none" stroke="currentColor" viewBox="0 0 24 24"
        ...
        <div class="block mx-4 flex items-center">
            ...
            <larecipe-button tag="a" href="https://github.com/savannabits/acacia" target="__blank" type="black" class="mx-2 px-4">
